...
import { ListChecks, Sparkles, CheckCircle2, XCircle, RotateCcw, Download, ChevronDown } from 'lucide-react'
              ...
              {fileDropdownOpen && (
                <div className="absolute z-50 w-full mt-2 rounded-xl border border-purple-500/40 bg-white dark:bg-[#1e1e2e] shadow-xl overflow-hidden">
                  <button
                    ...
                    className="w-full px-4 py-3 text-left text-gray-400 hover:bg-purple-500/10 transition-colors"
                  >
                    Select a file...
                  </button>
